		  ...
		  <View
			...
			{this.props.item.subcategory.map((item, key) => (
			  <TouchableOpacity
				...
				<Text style={styles.text}>
				   Booked By : {this.props.item.msg}
				</Text>
				<Text style={styles.text}>
				   Number of Rooms : {this.props.item.room}
				</Text>
...
const CONTENT = [];   
export default class Hottels extends Component {
	...
	componentDidMount(){
        ...
        var query = docRef.where('user', '==', 'admin@gmail.com').get().then(snapshot=>{
            ...
            snapshot.docs.forEach(doc=>{
				...
				let timeshort=''
				let head =''
				let mob = doc.data().bookedbynum
				let msg = doc.data().bookedby
